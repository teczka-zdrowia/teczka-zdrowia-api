...
return [
    ...
    'attributes' => [
        'data.name' => "Nazwa",
        'name' => "Nazwa",
        'data.username' => "E-mail",
        'data.email' => "E-mail",
        'email' => "E-mail",
        'data.password' => "Hasło",
        'data.new_password' => "hasła",
        'data.pesel' => "PESEL",
        'data.phone' => "Numer telefonu",
        'phone' => "Numer telefonu",
        'data.rules_accepted' => "Regulamin",
        'confirmed' => "Potwierdzenie",
        'data.confirmed' => "Potwierdzenie",
        'data.note' => "Notatka",
        'data.date' => "Data",
        'data.title' => "Tytuł",
        'data.file' => "Plik",
        'data.treatments' => "Zabiegi",
        'data.city' => "Miasto",
        'data.address' => "Adres",
        'data.agreement' => "Zgoda",
        'data.description' => "Opis",
        'data.start_date' => "Data rozpoczęcia",
        'data.days' => "Liczba dni",
    ],
